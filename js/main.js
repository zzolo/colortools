...
(function($, w, undefined) {
  ...
  var colorset = ['#EDF8B1', '#7FCDBB', '#2C7FB8'];
  var colorset = ['#F7E1C5', '#6A000B'];
  var colorset = ['#CCFF33', '#3366FF'];
  var steps = 7;
  ...
  $(document).ready(function() {
    showScale($('.color-space.rgb'), cSpace.rgb);
    showScale($('.color-space.hsv'), cSpace.hsv);
    showScale($('.color-space.hcl'), cSpace.hcl);
    showScale($('.color-space.hsi'), cSpace.hsi);
    showScale($('.color-space.lab'), cSpace.lab);
  });
